...
public class BankAccount {
    ...
    private public void setData(String ownerName, BigDecimal balance) {
        this.accountNumber = nextNumber();
        this.ownerName = ownerName;
        this.balance = balance;
    }
...
class CreateAccount {
    ...
    public static void main(String[] args) {
        ...
        account1 = new BankAccount(AccountType.Deposit);
        account2 = new BankAccount("Celine", new BigDecimal("100"));
        account3 = new BankAccount("Jason", AccountType.Saving, new BigDecimal("100"));
